...
def build_loaders(root_dir, tokenizer, batch_size=4, num_workers=4, prompt_file=None):
    train_sets, val_sets, loaders = {}, {}, {}
    for oid in ORGANS.keys():
        try:
            full_ds = OrganSliceDataset(root_dir, organ_id=oid, tokenizer=tokenizer, prompt_file=prompt_file)
        except RuntimeError:
            continue
...
def main():
    ...
    loaders = build_loaders(args.tr_npy_path, tokenizer=tokenizer,
