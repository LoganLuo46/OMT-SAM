...
out_file = "clip_train.log.csv"
plot_file = "clip_train.log.png"

# List of organs (update if your organ set changes)
organ_names = [
    "Liver", "Right_kidney", "Spleen", "Pancreas", "Aorta", "Ivc",
    "Right_adrenal_gland", "Left_adrenal_gland", "Gallbladder",
    "Esophagus", "Stomach", "Left_kidney"
]
